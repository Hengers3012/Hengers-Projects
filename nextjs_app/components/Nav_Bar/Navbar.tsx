...
function Navbar() {
  return (
    <div className=" flex max-w-full bg-gray-800 m-4 pl-4 pr-4 rounded-xl h-20 md:">
      <nav className="flex w-full items-center justify-between">
        <div className="flex whitespace-nowrap">
          <Image
            className=" animate-pulse duration-100 ease-linear bg-gradient-to-br"
        ...
        <div className=" max-w-full mx-4 justify-between whitespace-nowrap">
          <Link href={"home"} className="mx-4 ">
            <button className=" p-2 text-xl rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
              Home
            </button>
          </Link>
          <Link href={"about"} className="mx-4">
            <button className="p-2 text-xl rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              About
            </button>
          </Link>
          <Link href={"contacts"} className="mx-4">
            <button className="p-2 text-xl rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              Contacts
            </button>
          </Link>
